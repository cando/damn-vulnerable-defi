...
contract WithdrawalChallenge is Test {
    ...
    function test_withdrawal() public checkSolvedByPlayer {
        // sender of all events is l2handler @ 0x87EAD3e78Ef9E26de92083b75a3b037aC2883E16
        // target of all events is l1forwarder @ 0xfF2Bd636B9Fc89645C2D336aeaDE2E4AbaFe1eA5
        // target final of the real call is tokenBridge @ 0x9c52B2C4A89E2BE37972d18dA937cbAd8AA8bd50
        // and they are calling executeTokenWithdrawal(address,uint256)

        // console.log(l2MessageStore);
        // console.log(l2TokenBridge);
        // console.log(l2Handler);
        // console.log(address(l1Gateway));
        ...
        vm.warp(1718786915 + 10 days);
        // Put your JSON under: testdata/events.json (or wherever)
        ...
        // it will fail silently due to result not checked and balance not enough
        l1Gateway.finalizeWithdrawal(
            2,
            l2Handler,
            address(l1Forwarder),
